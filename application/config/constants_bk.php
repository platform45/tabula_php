...
define('MAX_UPOAD_PDF_SIZE',5120);
define('ADMIN_MENU_ICONS','http://'.$_SERVER['HTTP_HOST'].'/Tabula/assets/images/icons/');
...
define('INVALID_ADDRESS','Please enter valid address.');
...
define('TOP_10_RESTAURANTS','Top 10 restuarants found');
...
// For ios
define('DEV_PEM_FILE','assets/certificate/TabulaCertificates.pem');
define('DEV_PASSPHRASE','P@123');
define('DEV_SSL_URL','ssl://gateway.sandbox.push.apple.com:2195');

define('LIVE_PEM_FILE','assets/certificate/TabulaCertificates.pem');
define('LIVE_PASSPHRASE','P@123');
...
define('LIVE_FIREBASE_API_KEY','AIzaSyCKVdM-sVkQUaHP4kAdDzQWyuMUDZowM5E');
...
define('NOTIFICATION_FAILED','No notification results found.');
