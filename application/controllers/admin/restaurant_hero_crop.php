...
class Restaurant_hero_crop extends CI_Controller {
  ...
  public function index() {
    ...
    $imageName = $this->session->userdata('uploaded_img_hero');
    $data['sImageName'] = $imageName;
        # PROCESSING ------------------------------------------------------------------
    $this->template->view('image_crop_hero_restaurant', $data);
  }
