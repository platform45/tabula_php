                                    ...
                                    <div class="container-fluid eg-container" id="basic-example">
                                        <div class="eg-main">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <form action="<?php echo base_url();?>admin/header_crop/process" method="post" >
                                                    <div class="eg-data">
...
<style>
    <?php if($this->session->userdata('edit_menu_id')==143){?>
    .preview-lg {
    height: 188px;
    width: 200px;
}
...
<script>
    ...
    $.magnificPopup.instance.close = function () {
        ...
        window.location.href="<?php echo base_url();?>header_crop/process/closed";
