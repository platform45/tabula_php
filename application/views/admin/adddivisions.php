...
$(document).ready(function(){
    <?php $arr = $this->session->userdata('menu')?>
        ...
        $('#frmSlider').validate({
                rules:{
                        txttitle:{
                            required:true,
                            remote:{
                                url: "<?php echo base_url().'divisions/check_title_exists/'.$edit_id;?>",
                                type: "post",
                                data: {
                ...
                messages:{
                        txttitle:{
                            ...
                            remote : "Division title already exist."
                        }
                }
        });			
    });
        ...
        <div class="content">
                <div class="header">
                        <h1 class="page-title"><?php echo ($edit_id ? "Edit" : "Add");?> Divisions</h1>
                        <ul class="breadcrumb">
				...
				<div class="error">* indicates required field.</div>
					<div class="panel panel-default" align="left" style="border:0px;">
                                        ...
                                        <div class="dialog1">
					<form id="frmSlider" action="<?php echo base_url();?>divisions/addedit" method="POST" enctype="multipart/form-data" class="form-horizontal">
						...
						<div class="form-group">
							...
							<progress style="display:none;"></progress>
								...
								<input type="button" value="Cancel" style="margin-left:10px" class="btn btn-primary" onclick="javascript:window.location.href='<?php echo base_url();?>divisions'"/>
						</div>
					</form>
                                </div>
                                </div>
