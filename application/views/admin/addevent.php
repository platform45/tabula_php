...
//        content_css : "<?php echo $this->config->item('assets'); ?>front/css/editor_style.css",
    ...
    $(document).ready(function(){
       ...
       $('#txtdate').datetimepicker({onSelect: function(selected) {
    $("#txttodate").datetimepicker("option","minDate", selected)
},dateFormat: 'mm/dd/yy',timeFormat: 'hh:mm TT',use24hours: false, changeMonth:true, changeYear:true
});
     $('#txttodate').datetimepicker({onSelect: function(selected) {
           $("#txtdate").datetimepicker("option","maxDate", selected)
 },dateFormat: 'mm/dd/yy',timeFormat: 'hh:mm TT',use24hours: false, changeMonth:true, changeYear:true
 
});  
    
//    
//        $( "#txtdate" ).datetimepicker({ dateFormat: 'mm/dd/yy',timeFormat: 'hh:mm TT', use24hours: false, changeMonth:true, changeYear:true});
//        //$( "#event_end_date" ).datetimepicker({ dateFormat: 'mm/dd/yy',timeFormat: 'hh:mm TT', use24hours: false, changeMonth:true,changeYear:true});	
//    
//        $( "#txttodate" ).datetimepicker({ dateFormat: 'mm/dd/yy',timeFormat: 'hh:mm TT', use24hours: false, minDate :  $( "#txtdate" ).val(), changeMonth:true,changeYear:true});	
//    
//    
                ...
                var validator = $("#frmSlider").submit(function() {
                    ...
                    rules: {
                        txttitle:{
                            required:true,
                            remote:{
                                url: "<?php echo base_url() . 'admin/event/check_title_exists/' . $edit_id; ?>",
                                type: "post",
                                data: {
...
<?php } ?>
                                                    ...
                                                    errorPlacement: function(label, element) {
                                                        ...
                                                        image:{
                                                            ...
                                                            accept: "Extension should be jpg,jpeg or bit."
                                                        },
                                                        txtdate:{
...
<div class="content">
    <div class="header">
        <h1 class="page-title"><?php echo ($edit_id ? "Edit" : "Add"); ?> Event</h1>
        <ul class="breadcrumb">
    ...
    <div class="main-content">
        ...
        <div class="panel panel-default" align="left" style="border:0px;">
            ...
            <div class="panel-body" >
                <div class="dialog1">
                    <form id="frmSlider" action="<?php echo base_url(); ?>admin/event/addedit" method="POST" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">From Date<span class="error" >*</span></label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">To Date<span class="error" >*</span></label>
                            <div class="col-sm-6">
                                <input autocomplete="off" type="text" value="<?php echo set_value('txttodate', $formData['txttodate']); ?>" id="txttodate" name="txttodate" class="form-control" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input autocomplete="off" type="text" value="<?php echo set_value('txttitle', $formData['txttitle']); ?>" id="txttitle" name="txttitle" class="form-control" />
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Location<span class="error" >*</span></label>
                            <div class="col-sm-6">
                                <input type="text" value="<?php echo set_value('txtlocation', $formData['txtlocation']); ?>" id="txtlocation" name="txtlocation" class="form-control" />
                                <label id="txtlocation-error" class="error" for="txtlocation"></label>

                            </div>
                            <label class="col-sm-3 control-label"></label>	
                            <!--								<div class="col-sm-offset-3 col-sm-6">Note : Please use '*' character for line break.</div>-->
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-6">
                                ...
                                <input type="button" value="Cancel" style="margin-left:10px" class="btn btn-primary" onclick="javascript:window.location.href='<?php echo base_url(); ?>admin/event'"/>
                            </div>
                    </form>
                </div>
            </div>
