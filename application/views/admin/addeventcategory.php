...
$(document).ready(function(){
    <?php $arr = $this->session->userdata('menu')?>
        ...
        $('#frmSlider').validate({
                rules:{
                        txttitle:{
                            required:true,
                            remote:{
                                url: "<?php echo base_url().'eventcategory/check_title_exists/'.$edit_id;?>",
                                type: "post",
                                data: {
                ...
                messages:{
                        txttitle:{
                            ...
                            remote : "Category title already exist."
                        }
                }
        });			
    });
        ...
        <div class="content">
                <div class="header">
                        <h1 class="page-title"><?php echo ($edit_id ? "Edit" : "Add");?> Event Category</h1>
                        <ul class="breadcrumb">
                                <li><a href="<?php echo base_url();?>admin/dashboard">Home</a> </li>
                                <li><a href="<?php echo base_url();?>eventcategory">Event Category</a></li>
				...
				<div class="error">* indicates required field.</div>
					<div class="panel panel-default" align="left" style="border:0px;">
                                        ...
                                        <div class="dialog1">
					<form id="frmSlider" action="<?php echo base_url();?>eventcategory/addedit" method="POST" enctype="multipart/form-data" class="form-horizontal">
						...
						<div class="form-group">
								<label class="col-sm-3 control-label">Category Title<span class="error" >*</span></label>
                                <div class="col-sm-6">
						...
						<div class="form-group">
							...
							<progress style="display:none;"></progress>
								...
								<input type="button" value="Cancel" style="margin-left:10px" class="btn btn-primary" onclick="javascript:window.location.href='<?php echo base_url();?>eventcategory'"/>
						</div>
					</form>
                                </div>
                                </div>
