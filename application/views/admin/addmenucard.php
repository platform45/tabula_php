...
<div class="content">
    <div class="header">
        <h1 class="page-title"><?php echo ($edit_id ? "Edit" : "Add"); ?> Menucard</h1>
        <ul class="breadcrumb">
            <li><a href="<?php echo base_url(); ?>admin/dashboard"><i class="fa fa-home"></i> Home</a> </li>
            <li><a href="<?php echo base_url() . 'admin/menucard/menucard_list/' ?>">Menucard</a></li>
            <li class="active"><?php echo ($edit_id ? "Edit Menucard" : "Add Menucard"); ?></li>
        </ul>
    </div>
                    ...
                    <form id="frmSlider" action="" method="POST" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-6">
                                ...
                                <input type="button" value="Cancel" style="margin-left:10px" class="btn btn-primary" onclick="javascript:window.location.href='<?php echo base_url() . 'admin/menucard/menucard_list' ?>'"/>
                            </div>
                    </form>
                </div>
            </div>
