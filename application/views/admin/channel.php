				...
				<div class="table-responsive">
                    <table class="display hover cell-border table" id="test">
                        <thead>
                            ...
                            <th class="row-col_1"> FREE VIDEOS</th>
                        ...
                        <tbody>
                            ...
                            <?php 
                            if($channelData)
                            foreach($channelData as $rec):
                                $path = $rec['channel_image'];
                            ...
                            <tr style="text-align:center;">
                                ...
                                <td> <img width="100" id="preview" name="preview" src="<?php if($rec['channel_image']) echo $this->config->item('assets').'upload/brand/'.$thumb_img; else echo $this->config->item('assets').'upload/No_Image_thumb.jpg';?>"/> </td>
                                <td>
                                        <a data-id="<?php echo $rec['channel_id'];?>" style="margin-right:15px;" title="Move up" class="moveup pull-right" id="mp_<?php echo $rec['channel_id'];?>" href="<?php echo base_url().'admin/channel/change_sequence/up/'.$rec['channel_id'];?>">
                                            <i class="fa  fa-arrow-circle-up fa-2x"></i>
                                        </a>
                                        <a data-id="<?php echo $rec['channel_id'];?>" style="margin-right:15px;" title="Move down" class="movedown pull-right" id="mp_<?php echo $rec['channel_id'];?>" href="<?php echo base_url().'admin/channel/change_sequence/down/'.$rec['channel_id'];?>">
                                            <i class="fa  fa-arrow-circle-down fa-2x"></i>
                                        </a>
                                </td>
                                <?php 
                                $videoData = $this->channelmodel->getVideos($rec['channel_id']);
                                $canAdd =0;
                                $src="#";
                                $color="color:#ccc";
                                ...
                                {
                                    $canAdd =1;
                                    $src= base_url().'admin/channel/freeVideo/'.$rec['channel_id'];
                                     $color="";
                                }
                                
                                
                                ?>
                                 <td><a href="<?php echo $src ?>" title="Add Videos"><i style="<?php echo $color ?>" class="fa fa-plus fa-2x" ></i></a></td>
                                <td> <a title="Change status" href="#myStatus" role="button" data-toggle="modal" id="<?php echo $rec['channel_id'];?>" class="status" data-status="<?php echo $rec['channel_status'];?>"><span id="status<?php echo $rec['channel_id'];?>" class="status_icon"><?php if($rec['channel_status']==0):?><i class="fa fa-ban fa-2x" ></i><?php else:?><i class="fa fa-check fa-2x" ></i><?php endif?></span></a></td>
                                <td><a href="<?php echo base_url().'admin/channel/addedit/'.$rec['channel_id'];?>" title="Edit Channels"><i class="fa fa-pencil-square-o fa-2x" ></i></a></td>
                                <td><a href="#myModal" class="delete_button" id="<?php echo $rec['channel_id'];?>" role="button" data-toggle="modal" title="Delete"><i class="fa fa-times-circle-o fa-2x" ></i></a></td>
                            </tr>
                            <?php endforeach ?>
                        </tbody>
                    </table>
