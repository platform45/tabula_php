...
<div class="content">
  <div class="header">
    <h1 class="page-title">Crop Hero Image</h1>
  </div><!-- header -->
            ...
            <div class="eg-preview clearfix">
              <div class="preview preview-lg"></div>
                            <!--          <div class="preview preview-md"></div>
                                    ...
                                    <form action="<?php echo base_url(); ?>admin/restaurant_hero_crop/process" method="post" >
                                      <div class="eg-data">
...
$.magnificPopup.instance.close = function () {
  ...
  window.location.href="<?php echo base_url(); ?>admin/restaurant_hero_crop/process/closed";
