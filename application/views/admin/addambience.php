        ...
        $('#frmSlider').validate({
            rules:{
                txttitle:{
                    required:true,
                    remote:{
                        url: "<?php echo base_url() ?>admin/ambience/check_ambience_exist/<?php echo $edit_id ?>",
                        type: "post",
                        data: {
            ...
            messages:{
                txttitle:{
                    required:"Please enter amenities title.",
                    remote:"Amenities already exist."
                }
...
<div class="content">
    <div class="header">
        <h1 class="page-title"><?php echo ($edit_id ? "Edit" : "Add"); ?> Amenities</h1>
        <ul class="breadcrumb">
            <li><a href="<?php echo base_url(); ?>admin/dashboard"><i class="fa fa-home"></i> Home</a> </li>
            <li><a href="<?php echo base_url(); ?>admin/ambience">Amenities</a></li>
            <li class="active"><?php echo ($edit_id ? "Edit" : "Add"); ?> Amenities</li>
        </ul>
    </div>
    <div class="main-content">
        ...
        <div class="panel panel-default" align="left" style="border:0px;">
            <div class="panel-body" >
                <div class="dialog1">
                    <form id="frmSlider" action="<?php echo base_url(); ?>admin/ambience/addedit" method="POST" enctype="multipart/form-data" class="form-horizontal">

                        <input type="hidden" id="edit_id" name="edit_id" value="<?php echo $edit_id; ?>"/>
                        <div class="form-group">
                            <label class="col-sm-3 control-label text-left" >Amenities Title<span class="error" >*</span></label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-6">
                                ...
                                <input type="button" value="Cancel" style="margin-left:10px" class="btn btn-primary" onclick="javascript:window.location.href='<?php echo base_url(); ?>admin/ambience'"/>
                            </div>
                    </form>
                </div>
            </div>
