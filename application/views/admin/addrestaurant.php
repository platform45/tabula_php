...
//        });
        ...
        $.validator.addMethod('validateCheckBoxes', function (value) {
            return $('.validateCheckBoxes:checked').size() > 0;
        }, 'Please select days.');
        ...
        $('#user_form').validate({
            ...
            messages: {
                ...
                'cusine[]': {
                    ...
                    maxlength: "You can only select 3 cuisine."
                },
                'ambience[]': {
    ...
    function loadCloseTimeSlots(selectedValue,day) {
        $.ajax({
            url: '<?php echo base_url(); ?>admin/restaurant/get_closing_slots',
            type: "POST",
            data: {
...
<div class="content">
    <div class="header">
        <h1 class="page-title"><?php echo($edit_id ? "Edit" : "Add"); ?> Restaurant</h1>
        <ul class="breadcrumb">
            <li><a href="<?php echo base_url(); ?>admin/dashboard"><i class="fa fa-home"></i> Home</a></li>
            <li><a href="<?php echo base_url(); ?>admin/restaurant">Restaurant</a></li>
            <li class="active"><?php echo($edit_id ? "Edit" : "Add"); ?> Restaurant</li>
        </ul>
    </div>
                ...
                <div class="dialog1">
                    ...
                    <form id="user_form" action="" method="POST" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <input type="hidden" id="hero_image" name="hero_image"
                               value="<?php echo set_value('hero_image'); ?>"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text"
                                       value="<?php echo trim(set_value('user_first_name', $formData['txtrname'])); ?>"
                                       id="txtrname" name="txtrname" class="form-control" maxlength="40"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Cuisine Title<span class="error">*</span></label>
                            <div class="col-sm-7 cusine">
                                <select class="form-control" name="cusine[]" id="cusine" class="form-control"
                                        aria-invalid="false" width="auto" multiple>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7 ambience">
                                <select name="ambience[]" id="ambience" multiple="multiple" class="form-control"
                                        aria-invalid="false">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Dietary Preference Title<span
                                        class="error">*</span></label>
                            <div class="col-sm-7 dietary">
                                <select name="dietary[]" id="dietary" multiple="multiple" class="form-control"
                                        aria-invalid="false">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" <?php echo($edit_id > 0 ? "readonly='readonly'" : ""); ?>
                                       value="<?php echo set_value('user_email', $formData['txtemail']); ?>"
                                       id="txtemail" name="txtemail" class="form-control" maxlength="40"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Password<span
                                        class="error"><?php echo($edit_id > 0 ? "" : "*") ?></span></label>
                            <div class="col-sm-7">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Confirm Password<span
                                        class="error"><?php echo($edit_id > 0 ? "" : "*") ?></span></label>
                            <div class="col-sm-7">
                                <input id="conf_password" name="conf_password" value="" type="password"
                                       class="form-control"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Name of Contact Person<span
                                        class="error">*</span></label>
                            <div class="col-sm-7">
                                <input type="text"
                                       value="<?php echo trim(set_value('restaurant_owner_name', $formData['resownername'])); ?>"
                                       id="resownername" name="resownername" class="form-control" maxlength="40"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text"
                                       value="<?php echo set_value('user_contact', $formData['txtcontact']); ?>"
                                       id="txtcontact" name="txtcontact" class="form-control" maxlength="40"/>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-7">
                                <select class="form-control" name="country_id" id="country_id" aria-invalid="false"
                                    ...
                                    <?php foreach ($countriesData as $res) {
                                        ?>
                                        <option <?php echo($res['cou_id'] == '47' ? "selected='selected'" : ""); ?>
                                                value="<?php echo $res['cou_id']; ?>"><?php echo htmlentities(stripslashes($res['cou_name'])); ?></option>
                                    <?php }
                                    ?>
                                </select>
                            </div>
                            ...
                            <div class="col-sm-7">
                                <select class="form-control" name="region_id" id="region_id" aria-invalid="false">
                                    ...
                                    <?php foreach ($regionsData as $res) {
                                        ?>
                                        <option <?php echo($res['region_id'] == $formData['region_id'] ? "selected='selected'" : ""); ?>
                                                value="<?php echo $res['region_id']; ?>"><?php echo htmlentities(stripslashes($res['region_name'])); ?></option>
                                    <?php }
                                    ?>
                                </select>
                            </div>
                            ...
                            <div class="col-sm-7">
                                <select class="form-control" name="city_id" id="city_id" aria-invalid="false">
                                    ...
                                    <?php foreach ($citiesData as $res1) {
                                        ?>
                                        <option <?php echo($res1['city_id'] == $formData['city_id'] ? "selected='selected'" : ""); ?>
                                                value="<?php echo $res1['city_id']; ?>"><?php echo htmlentities(stripslashes($res1['city_name'])); ?></option>
                                    <?php }
                                    ?>
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" maxlength="100"
                                       value="<?php echo trim(set_value('street_address1', $formData['address'])); ?>"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                ...
                                <select class="form-control" name="avgspend" id="avgspend" aria-invalid="false">
                                    ...
                                    <option value="1" <?php echo $formData['avgspend'] == 1 ? "selected='selected'" : ""; ?> >
                                        R0-R100 – 1 R
                                    </option>
                                    <option value="2" <?php echo $formData['avgspend'] == 2 ? "selected='selected'" : ""; ?> >
                                        R101 - R200 – 2 R
                                    </option>
                                    <option value="3" <?php echo $formData['avgspend'] == 3 ? "selected='selected'" : ""; ?> >
                                        R201 - R400 – 3 R
                                    </option>
                                    <option value="4" <?php echo $formData['avgspend'] == 4 ? "selected='selected'" : ""; ?> >
                                        R401 - R600 – 4 R
                                    </option>
                                    <option value="5" <?php echo $formData['avgspend'] == 5 ? "selected='selected'" : ""; ?> >
                                        R601 – R800 – 5 R
                                    </option>
                                    <option value="6" <?php echo $formData['avgspend'] == 6 ? "selected='selected'" : ""; ?> >
                                        R801 - R1000 – 6 R
                                    </option>
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text"
                                       value="<?php echo trim(set_value('user_description', $formData['description'])); ?>"
                                       id="description" name="description" class="form-control" maxlength="350"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" value="<?php echo trim(set_value('web_domain', $formData['web_domain'])); ?>"
                                       id="txtrwebdomain" name="txtrwebdomain" class="form-control" maxlength="50"/>
                            </div>
                        </div>
                                                    ...
                                                    if ($edit_id) {
                                                        ...
                                                        foreach ($restaurantTimeData as $row) {
                                                            if ($row['open_close_day'] == '4' && $row['open_close_status'] == '1' && date('H:i', strtotime($row['open_time_from'])) == date('H:i', strtotime($slots->time_slot))) { ?>
                                                                <option value="<?php echo $slots->time_slot; ?>" selected> <?php echo $slots->time_slot; ?> </option>
                                                                <?php $wednesday_flag = 1;
                                                            }
                                                        }
                                                        ?>
														<?php if($wednesday_flag != 1){ ?>
                                                        <option value="<?php echo $slots->time_slot; ?>"> <?php echo $slots->time_slot; ?> </option>
                                                        <?php } else { $wednesday_flag = 0; }
                                                    } else { ?>
                                                        <option value="<?php echo $slots->time_slot; ?>"> <?php echo $slots->time_slot; ?> </option>
                                                    <?php }
                                                endforeach; ?>
                        ...
                        <div class="form-group" id="image_preview">
                            <div class="col-sm-offset-3 col-sm-7">
                                <img id="preview" name="preview" width="150" height="150"
                                     src="<?php if ($formData['new_img']) echo base_url() . MEMBER_IMAGE_PATH . $formData['new_img']; else echo $this->config->item('assets') . 'upload/adminuser/restaurant.jpg'; ?>"/>
                                <p><b>Note:</b> Image should be jpg, jpeg.</p>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Restaurant Hero Image<span
                                        class="error">*</span></label>
                            <div class="col-sm-7"><input type="file" id="h_image" name="h_image" value=""/></div>
                        </div>
                        <div class="form-group" id="image_preview">
                            <div class="col-sm-offset-3 col-sm-7">
                                <img id="preview" name="preview" width="150" height="130"
                                     src="<?php if ($formData['hero_image']) echo base_url() . MEMBER_IMAGE_PATH . $formData['hero_image']; else echo $this->config->item('assets') . 'upload/adminuser/restaurant.jpg'; ?>"/>
                                <p><b>Note:</b> Image should be jpg, jpeg.</p>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-offset-3 col-sm-7">
                                <input type="submit" value="<?php echo($edit_id ? "Update" : "Save"); ?>"
                                       class="btn btn-primary" id="btnSubmit"/>
                                <input type="button" value="Cancel" style="margin-left:20px" class="btn btn-primary"
                                       onclick="javascript:window.location.href='<?php echo base_url(); ?>admin/restaurant'"/>
                            </div>
                        </div>
                    </form>
                </div>
