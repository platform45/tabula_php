                                    ...
                                    <div class="container-fluid eg-container" id="basic-example">
                                        <div class="eg-main">
                                            ...
                                            <div class="col-sm-3">
                                               ...
                                               <!-- <form action="<?php echo base_url();?>admin/slider_crop/process" method="post" >-->
												 <?php $attributes = array('method' => 'post'); ?>
												<?php echo form_open('admin/promotion_crop/process',$attributes);?>
                                                    <div class="eg-data">
...
<script>
    ...
    $.magnificPopup.instance.close = function () {
        ...
        window.location.href="<?php echo base_url();?>admin/promotion_crop/process/closed";
