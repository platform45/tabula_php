            ...
            <div class="container-fluid eg-container" id="basic-example">
                <div class="eg-main">
                    ...
                    <div class="col-sm-3">
                        ...
                        <form action="<?php echo base_url(); ?>admin/menucard_crop/process" method="post" >
                            <div class="eg-data">
...
<script>
    ...
    $.magnificPopup.instance.close = function () {
        ...
        window.location.href="<?php echo base_url(); ?>admin/menucard_crop/process/closed";
