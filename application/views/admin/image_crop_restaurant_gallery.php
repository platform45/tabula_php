...
<script>
    $(document).ready(function(){
        ...
        $('#basic-example').click(function(event){
...
<div class="content">
    <div class="header">
        <h1 class="page-title">Image Crop</h1>
    </div><!-- header -->
    ...
    <div class="main-content addstanding">
        <div id="test-modal" style="margin-top:50px;" class="white-popup-block mfp-hide">
            <div class="container-fluid eg-container" id="basic-example">
                <div class="eg-main">
                    <div class="col-sm-9">
                        <div class="eg-wrapper" id="eg-wrapper">
                    ...
                    <div class="col-sm-3">
                        ...
                        <form action="<?php echo base_url(); ?>admin/restaurant_gallery_crop/process" method="post" >
                            <div class="eg-data">
...
<script>
    ...
    $.magnificPopup.instance.close = function () {
        ...
        window.location.href="<?php echo base_url(); ?>admin/restaurant_gallery_crop/process/closed";
