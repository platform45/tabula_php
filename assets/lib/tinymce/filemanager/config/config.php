...
$upload_dir = '/~tabula/assets/upload/tinymice/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../../upload/tinymice/'; // relative path from filemanager folder to upload folder (with final /)
