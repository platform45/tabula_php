(function($) {
    $.fn.ashtml5lightbox = function(options) {
        ...
        inst.createMarkup = function() {
            ...
            if (inst.options.stamp) inst.$watermark.html("<a href='" + inst.options.freelink + "' style='text-decoration:none;' title='jQuery Lightbox'><div style='display:block;width:80%;height:8%;text-align:center;border-radius:3px;-moz-border-radius:3px;-webkit-border-radius:3px;background-color:#fff;color:#333;font:12px Arial,sans-serif;'><div style='line-height:20px;'>" +
    ...
    $.fn.amazingslider = function(options) {
        ...
        AmazingSlider.prototype = {
            ...
            createStyle: function() {
                if (!this.options.isresponsive || !this.container.parent() ||
            ...
            createArrows: function() {
				...
				$.session.set("rightArrow",$rightArrow);
				$.session.set("instance",instance);
				$.session.set("container",this.container);
            ...
            carMoveBottom: function() {
                ...
                var l = (isNaN(parseInt($bulletWrapper.css("margin-top"))) ?
                    0 : parseInt($bulletWrapper.css("margin-top"))) + 53/*dist*/;
                if (l <= $navContainer.height() - $bulletWrapper.height()) l = $navContainer.height() - $bulletWrapper.height();
                if(this.curElem == this.elemArray.length - 1)
            ...
            carMoveTop: function() {
                ...
                if (this.options.navshowpreview) $(".amazingslider-nav-preview-" + this.id, this.container).hide();
                var dist = $navContainer.height() + this.options.navspacing ;
				var l = (isNaN(parseInt($bulletWrapper.css("margin-top"))) ? 0 : parseInt($bulletWrapper.css("margin-top"))) - 53/*(dist)*/;
				//alert(temp);
                if (l <= $navContainer.height() - $bulletWrapper.height() ) l = $navContainer.height() - $bulletWrapper.height();
                if(this.curElem == 0)
					l=0;
            ...
            createNav: function() {
                ...
                if (this.options.navdirection == "vertical") {
                    var len = this.options.navstyle == "none" ? 0 : (this.elemArray.length ) * 41.5/*this.options.navheight*/ + (this.elemArray.length - 1) * this.options.navspacing;
					//alert(this.options.navheight);
                    ...
                    if (instance.options.navthumbnavigationstyle == "auto") $nav.mousemove(function(e) {
                        ...
                        $carLeftArrow.css({
                            ...
                            height: instance.options.navthumbnavigationarrowimageheight +
                                "px",
                            background: "url('../assets/images/up-arrow.png') no-repeat left "
                        });
                        $carRightArrow.css({
                            overflow: "hidden",
                            position: "absolute",
            ...
            createNavBullet: function(index) {
                ...
                var $bullet = $("<div class='amazingslider-bullet-" + this.id + "-" + index + "' style='position:relative;float:" + f + ";" + b + "margin-" + marginF + ":" + spacing + "px;width:80%;min-height:40px;cursor:pointer;'></div>");
                ...
                if (this.options.navstyle == "bullets") {
                    ...
                    $bullet.css({
                        padding: "0px"//this.options.navborder + "px"
                    });
                    $bullet.css({
                    ...
                    $(imgLoader).load(function() {
                        if (instance.options.navthumbstyle != "textonly") {
                            ...
                            if (this.width / this.height <= instance.options.navimagewidth / instance.options.navimageheight) 
								style = "max-width:none !important;width:100%;height:auto;margin-top:-1px"; //+ Math.floor(this.height / this.width * instance.options.navimagewidth / 2 - instance.options.navimageheight / 2) + 
                            else 
								style = "max-width:none !important;width:auto;height:100%;margin-left:-" + Math.floor(this.width / this.height * instance.options.navimageheight / 2 - instance.options.navimagewidth / 2) + "px";
									$bullet.append("<div class='thumbimg amazingslider-bullet-image-" + instance.id + "' style='display:block;position:absolute;width:" + instance.options.navimagewidth + "px;overflow:hidden;'><img src='" + instance.elemArray[index][ELEM_THUMBNAIL] + "' style='" +
									style + "' /></div>");
                        ...
                        if (instance.options.navdirection == "horizontal") {
                            ...
                            if ($navContainer.height() < $bulletWrapper.height() && !instance.pauseCarousel) {
                                ...
                                if (pos.top < m || pos.top + instance.options.navheight > m + $navContainer.height()) {
                                    var pl = -pos.top;
                                    if (pl <= $navContainer.height() - $bulletWrapper.height()) pl = $navContainer.height() - $bulletWrapper.height() - 6;
                                    if (pl >= 0) pl = 0;
            ...
            showImage: function(slideDirection) {
                ...
                $(imgLoader).load(function() {
                    ...
                    else imgCurCodes += "max-width:" + instance.curImageMaxWidth + "%;width:" + instance.curImageMaxWidth + "%;height:100%;left:0%;top:0%;";
